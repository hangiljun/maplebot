...
const PRESETS = [
  ...
  { id: 'trend', icon: '◌', title: '커뮤니티 트렌드', desc: '최근 화제와 다양한 유저 반응을 정리', type: '커뮤니티·트렌드', topic: '커뮤니티 반응·게임 트렌드', purpose: '검색 유입', audience: '기존 유저', category: '블로그', sample: '최근 메이플 커뮤니티에서 자주 언급되는 변화와 유저 반응', include: '조사 기간, 반복해서 등장한 관심사, 긍정·부정·중립 의견, 공식 확인이 필요한 주장' },
